...
class NotesTableViewController: UITableViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "NoteDetailPush" {
            ...
            var noteDetail = segue.destination as! NoteDetailViewController
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("NoteDetailTableViewCell", forIndexPath: indexPath as IndexPath) as! NoteDetailTableViewCell
